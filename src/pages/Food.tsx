import { foods } from "@/constants/constant";
...
const Food = () => {
  ...
  return (
    <section className="w-full px-6 md:px-24 py-10 bg-[#FAE5C3] text-[#5A3E1B]">
      ...
      >
        Indian Cuisine: A Journey Through Flavors
      </motion.h1>
      ...
      >
        Indian food is a beautiful blend of flavors, spices, and traditions,
        reflecting centuries of cultural evolution. From the hearty Mughlai
        dishes of the North to the coconut-infused curries of the South, every
        region contributes to India's vast culinary heritage.
      </motion.p>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {foods.map((food, index) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500">{food.region}</p>
